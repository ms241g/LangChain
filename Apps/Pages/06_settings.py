...
# Get API keys
openai_api_key = st.text_input("Open AI-KEY", value=st.session_state.openai_api_key, type="password")
st.caption("*Required for all apps; get it [here](https://platform.openai.com/account/api-keys).*")

serper_api_key = st.text_input("SerpAI Key", value=st.session_state.serper_api_key, type="password")
